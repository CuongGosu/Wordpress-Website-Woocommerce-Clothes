            ...
            <?php do_action( 'woocommerce_checkout_payment' );?>
              ...
              <?php endif; ?>
                      ...
                      <noscript>
                        ...
                        ?>
                        <br/>
												<button type="submit" class="btn-checkout button alt" name="woocommerce_checkout_update_totals" value="<?php esc_attr_e( 'Update totals', 'woocommerce' ); ?>"><?php esc_html_e( 'Update totals', 'woocommerce' ); ?>
											</button>
                      </noscript>
      ...
      <div class="info-money-top">
            ...
            <div class="cart-shipping">
              ...
              <div class="cart-discount">
                <div colspan="2">Discount</div>
                <div>
                    <?php
                    $discount_total = WC()->cart->get_discount_total(); // Tổng giảm giá từ tất cả voucher
                    echo $discount_total > 0 ? wc_price($discount_total) : 'No discount applied';
                    ?>
                </div>
            </div>
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    radioButtons.forEach(radio => {
        ...
        radio.addEventListener('click', function () {
            ...
            const relatedSecondaryDiv = document.querySelector(targetSelector);
